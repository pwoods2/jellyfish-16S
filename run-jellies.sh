...
for filepath in "${files[@]}"; do
    ...
    echo ""
    nanoqc -o "$RAW_NANOPLOT/${base_name}.fastq.gz" "$filepath"
    echo ""
    NanoPlot --fastq "$filepath" -o "$RAW_NANOPLOT/${base_name}.fastq.gz"
    echo ""
    ...
    echo ""
    nanoqc -o "$PORECHOP_NANOPLOT/${base_name}.fastq.gz" "$PORECHOP_OUT/${base_name}.fastq.gz"
    echo ""
    NanoPlot --fastq "$PORECHOP_OUT/${base_name}.fastq.gz" -o "$PORECHOP_NANOPLOT/${base_name}.fastq.gz"
    echo ""
    ...
    echo ""
    nanoqc -o "$CHOPPER_NANOPLOT/${base_name}_trimmed.fastq" "$CHOPPER_OUT/${base_name}_trimmed.fastq"
    echo ""
    NanoPlot --fastq "$CHOPPER_OUT/${base_name}_trimmed.fastq" -o "$CHOPPER_NANOPLOT/${base_name}_trimmed.fastq"
    echo ""
